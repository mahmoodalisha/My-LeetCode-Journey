/*100646. Number of Ways to Assign Edge Weights I
User Accepted:4131
User Tried:4657
Total Accepted:4468
...
public:
    ...
    int assignEdgeWeights(vector<vector<int>>& edges) {
        ...
        // Variable to store input midway as per question
        vector<vector<int>> tormisqued = edges;

        // BFS to find max depth and corresponding node
