...
//Count elements on left and right of every middle element
//Fix middle index j, then count number of valid is (left of j) and ks (right of j) that satisfy increasing or decreasing sequence